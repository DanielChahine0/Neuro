...
const features: Feature[] = [
  ...
  },
  {
    ...
    description:
      "Every distraction is logged automatically — which apps and websites pulled your focus, and exactly how long you spent on each.",
  ...
  },
  {
    title: "Focus Score",
    description:
      "Get a real-time percentage showing how much of your session was productive versus distracted. Watch your focus improve over time.",
    mockup: <FocusScoreMockup />,
  },
  {
    title: "Stats & Streaks",
    description:
      "Weekly and monthly charts track your hours, distraction counts, and focus trends. Build streaks to stay consistent.",
    mockup: <StatsMockup />,
  },
  {
    title: "Social Accountability",
    description:
      "Invite friends, see who's in a session, and view each other's logged time. Stay accountable together.",
    mockup: <SocialMockup />,
  },
];
